...
class AddAppointments extends React.Component {
  ...
  save = (e) => {
    e.preventDefault();
    const { patientName, patientAge, gender, aptDate, aptTime, aptNotes, doctorName } = this.state;
    if (patientName !== "" && patientAge !== "" && doctorName !== "" && gender !== "" && aptDate !== "" && aptTime !== "" && aptNotes !== "") {
      let apt = {
        id: Date.now(),
        ...
        <CardBody style={displayBody} id="aptBody">
          ...
          <Form onSubmit={this.save}>
            ...
            <FormGroup>
              ...
              <Input type="select" id="doctorName"  value={this.state.doctorName} onChange={this.handleChange} >
